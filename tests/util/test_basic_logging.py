...
def test_fenicsx_loggers():
    ...
    assert initial_level == dolfinx.log.LogLevel.WARNING 
    assert initial_level.value == 3 #-1  # WARNING
    ...
    assert current_level.value == 4 #-2
    ...
    # ]
    dfx_levels = [
        (dolfinx.log.LogLevel.INFO, 2),
        (dolfinx.log.LogLevel.WARNING, 3),
        (dolfinx.log.LogLevel.ERROR, 4),
        (dolfinx.log.LogLevel.OFF, 6),
    ]
